...
function CheckOutContent() {
    ...
    const calculateFairLogic = (checkInStr: string) => {
        if (!transaction?.rate) return { durationText: '...', totalCost: 0 };
        ...
        return { durationText, totalCost };
    };

    const { durationText, totalCost } = transaction ? calculateFairLogic(transaction.check_in_time) : { durationText: '', totalCost: 0 };
                    ...
                    {transaction ? (
                        <div className="space-y-10 animate-in fade-in slide-in-from-top-4 duration-500">
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                {checkoutSuccess && (
                                    <div className="h-20 flex-[2] rounded-2xl bg-blue-600 flex items-center justify-center text-white text-xl font-black uppercase italic shadow-2xl shadow-blue-500/30">
