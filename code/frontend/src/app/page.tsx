  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F0F5FF]">
      ...
      <motion.header
        ...
        className="px-6 lg:px-12 h-20 flex items-center justify-between sticky top-0 bg-[#F0F5FF]/80 backdrop-blur-md z-50"
      >
      ...
      <main className="flex-1">
        ...
        <section className="py-24 px-6 text-center max-w-4xl mx-auto space-y-8">
          <ScrollSection direction="up" duration={0.8}>
          ...
          <ScrollSection direction="up" delay={0.2} duration={0.7}>
          ...
          <ScrollSection direction="up" delay={0.4} duration={0.6}>
            <Link href="/login">
        ...
        <section id="fitur" className="py-24 bg-[#1F2937] text-white">
          <div className="container mx-auto px-6">
            <ScrollSection direction="up" duration={0.7}>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              {[
                ...
                <ScrollSection key={idx} direction="up" delay={idx * 0.1} duration={0.5}>
                  <div className="bg-[#F9FAFB] p-8 rounded-xl border-b-8 border-[#374151] shadow-xl group hover:-translate-y-2 transition-transform h-full">
          ...
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-12 max-w-6xl mx-auto">
              {[
                ...
                <ScrollSection key={idx} direction="up" delay={idx * 0.12} duration={0.5}>
          ...
          <div className="container mx-auto px-6 text-center max-w-4xl">
            ...
            <div className="space-y-20 relative">
              ...
              {[
                ...
                <ScrollSection key={idx} direction={idx % 2 === 0 ? 'left' : 'right'} delay={0.1} duration={0.6}>
                  <div className="flex flex-col lg:flex-row items-center gap-12 text-left relative z-10 lg:even:flex-row-reverse">
                    <div className={cn(
      ...
      {/* Footer */}
      <ScrollSection direction="up" duration={0.5}>
