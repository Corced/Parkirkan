        ...
        <Popover open={isOpen} onOpenChange={setIsOpen}>
            <PopoverTrigger asChild>
                ...
                >
                    ...
                    {unreadCount > 0 && (
                        <span className="absolute -top-1 -right-1 h-5 w-5 bg-red-500 text-white text-base font-bold rounded-full flex items-center justify-center">
                            {unreadCount}
                        </span>
                    )}
                </Button>
            ...
            <PopoverContent className="w-96 p-0 z-50 bg-white shadow-2xl rounded-3xl border border-slate-100 overflow-hidden mt-4" align="end">
                <div className="p-4 border-b bg-slate-50">
                    ...
                    <p className="text-base text-slate-800 mt-1">Riwayat aktivitas terbaru</p>
                </div>
